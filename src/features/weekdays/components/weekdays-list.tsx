...
import { useAllWeekdaysQuery } from "../weekdays-api";
...
const WeekdaysList = () => {
    ...
    const { data, isFetching, error, isError } = useAllWeekdaysQuery(Object.assign({}, ...(params as any)));
    ...
    return (
        <div>
            ...
            <FloatingButton href={Routes.teacher.weekdays.add} label="اضافة جدول" />
        </div>
    );
};
